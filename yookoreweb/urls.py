...
urlpatterns = patterns('',
                       ...
                       url(r'^profile/(?P<username>[\w\d]+)/about$', 'userprofile_app.views.userprofile_about',
                           name='userprofile_about'),
                       url(r'^profile/(?P<username>[\w\d]+)/friends$', 'userprofile_app.views.userprofile_friends',
                           name='userprofile_friends'),
                       url(r'^profile/(?P<username>[\w\d]+)/blogs$', 'userprofile_app.views.userprofile_blogs',
                           name='userprofile_blogs'),
                       url(r'^profile/(?P<username>[\w\d]+)/blogs/create-post$',
                           'userprofile_app.views.userprofile_createpost', name='userprofile_createpost'),
                       url(r'^update_profile$', 'userprofile_app.views.update_user_profile', name="update_profile"),
